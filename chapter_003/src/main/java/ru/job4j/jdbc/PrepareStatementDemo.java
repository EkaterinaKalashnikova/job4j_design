...
public class PrepareStatementDemo {
    ...
    public void initConnection() throws Exception {
        ...
        String url = "jdbc:postgresql://localhost:5432/metropolis";
    ...
    public static void main(String[] args) throws Exception {
       City cityOne = new City(1, "Rostov", 1100);
       City cityTwo = new City(2, "Krasnodar", 800);
       City cityThree = new City(3, "Sochi", 450);
